...
// --- GET /api/tools --------------------------------------------------------
// Готовые пресеты для карусели "Инструменты" (промпт-шаблоны с фиксированной
// задачей, как у Umnik). Статический конфиг, не пользовательские данные —
// поэтому лежит в config/, а не в data/.
